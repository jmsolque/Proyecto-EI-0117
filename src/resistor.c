...
void aplicar_tema_css() {
    GtkCssProvider *provider = gtk_css_provider_new();
    gtk_css_provider_load_from_data(provider,
        "window { background: #0E1A2B; color: #FFFFFF; }"
        "label { color: #FFFFFF; font-weight: bold; }"
        "button { background: #1E2A3A; color: #00E0A1; border-radius: 6px; padding: 6px; }"
        "button:hover { background: #00E0A1; color: #0E1A2B; }"
        "combobox, entry { background: #1E2A3A; color: #FFFFFF; border: 1px solid #00E0A1; border-radius: 5px; }",
        -1);
